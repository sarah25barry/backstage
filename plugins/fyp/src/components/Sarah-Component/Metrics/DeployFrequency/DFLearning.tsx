...
const rows = [
  deploymentData(
    ...
    'Once every month - once every six months',
  ),
];

class DFLearning extends Component {
  render() {
    return (
      <Grid item xs={12}>
        <InfoCard>
          ...
          <Typography>
            ...
            time - this could be daily or monthly, then divide by the number of
            days/weeks in the period.
          </Typography>
          <h4>Evaluation</h4>
          <TableContainer component={Paper}>
            <Table
              sx={{ minWidth: 650 }}
              aria-label="deployment-frequency-criteria"
            >
              <TableHead>
